      ...
      <div className="container">
        {!carts?.length ? (
          ...
          <>
            ...
            {/* 結帳按鈕：按下顯示「填寫訂單資料」、按鈕變「取消結帳」；再按隱藏區塊、清空表單、按鈕變「結帳」 */}
            ...
            >
              <h4>填寫訂單資料</h4>
              <hr />
              <form action="" onSubmit={handleSubmit(onOrderSubmit)}>
                  <div className="container mb-5">
                      <div className="row g-3">
                        {/* 收件人資料 */}
                        <div className="col-12 col-md-6">
                          <div className="card">
                            <div className="card-header">收件人資料</div>
                            <div className="card-body">
                              <div className="row">
                                <div className="col-12">
                                  ...
                                  <label htmlFor="email" className="form-label">收件人EMAIL</label>
                                  <input 
                                  ...
                                  <label htmlFor="phone" className="form-label">收件人手機電話</label>
                                  <input 
                        ...
                        <div className="col-12 col-md-6">
                          <div>
                            <div className="card">
                              <div className="card-header">付款方式</div>
                              <div className="card-body">
                                <div className="row">
                                  <div className="col-12">
                                    <label htmlFor="payment_method" className="form-label">付款方式</label>
                                    <select
                                      id="payment_method"
                            ...
                            <br />
                            <div className="card">
                              <div className="card-header">付款金額</div>
                              <div className="card-body">
                                <table className="table table-bordered">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td className="text-start">最終金額(含稅)</td>
                                        <td><strong>NT：${(cartData.final_total * 1.05).toLocaleString()}</strong></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                      ...
                      <div className="row text-end mb-3">
                        ...
                        <button type="submit" className="btn btn-outline-danger btn-sm"
                          onClick={() => deleteCartAll()}>取消訂單</button>
                        </div>
                        <div className="col-12 col-md-6">
                          <button type="submit" className="btn btn-success">確認訂單</button>
                        </div>
                      </div>
                  </div>  
              </form>
